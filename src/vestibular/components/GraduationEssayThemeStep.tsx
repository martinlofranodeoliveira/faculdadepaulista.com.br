    ...
    <>
      {theme.imageSrc ? (
        <figure className="vestibular-essay__figure">
          <img src={theme.imageSrc} alt={`Imagem de apoio do ${theme.label}`} />
...
export function GraduationEssayThemeStep({
  ...
  return (
    <section className="vestibular-essay" aria-labelledby="vestibular-essay-title">
      <div className="vestibular-essay__shell">
        ...
        <div className="vestibular-essay__content vestibular-essay__content--mobile">
          {renderThemeContent(selectedTheme)}
        </div>
        ...
        <div className="vestibular-essay__content vestibular-essay__content--desktop">
          {renderThemeContent(selectedTheme)}
        </div>

        <div className="vestibular-essay__footer">
          <p>Quantidade de caracteres: 0</p>
